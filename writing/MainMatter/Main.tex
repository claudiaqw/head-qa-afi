...
El modelo que se presenta en esta sección sigue la arquitectura QA-LSTM introducida por \cite{2015-tan-qalstm}. 
...
El modelo que se presenta en esta sección sigue la arquitectura introducida por \cite{2015-tan-qalstm}. 
...
Sigue la misma idea pero en lugar de utilizar un red de tipo BiLSTM en las capas bases, utiliza un modelo BERT pre-entrenado.
