...
THe English HEAD-QA has been automatically translated from Spanish using Google translator. The quality of the translations was evaluated on a subset of the questions (see the paper for more details). Still, note that some translations will contain different types of errors. 
